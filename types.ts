...
export enum MapLayer {
  ...
  FOREST_FAGUS = 'Fagus sylvatica suitability',
  FOREST_ABIES = 'Abies alba suitability',
  FOREST_PICEA = 'Picea abies suitability',
  FOREST_PINUS_NIGRA = 'Pinus nigra suitability',
  FOREST_PINUS_SYLVESTRIS = 'Pinus sylvestris suitability',
  FOREST_QUERCUS_PETRAEA = 'Quercus petraea suitability',
  FOREST_QUERCUS_ROBUR = 'Quercus robur suitability',
  FOREST_QUERCUS_CERRIS = 'Quercus cerris suitability',
