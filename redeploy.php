...
$commands = [
    // dist/ is generated by Vite on the server but is still tracked by older
    // checkouts. Restore only those generated files so they cannot block the
    // next fast-forward pull; application source changes remain untouched.
    ['label' => 'Resetting generated frontend build', 'command' => 'git restore --source=HEAD --worktree -- dist'],
