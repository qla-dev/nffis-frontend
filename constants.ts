...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    firefighterStations: 'Firefighter Stations',
    firefighterDensity: 'Firefighters / Population',
    ...
    firefighterStation: {
      ...
      supervisor: 'Parent unit',
      phone: 'Phone',
      phoneAlt: 'Phone (secondary)',
      mobile: 'Mobile',
      email: 'Email',
      ...
      capacitySource: 'Data source',
      viewDetails: 'Tap marker for full details',
      unionContact: 'RS Fire Service Union',
      types: {
      ...
      locationPrecisions: {
        ...
        'municipality-seat': 'Municipality seat',
      },
    },
    riskLevels: {
      low: 'Low',
  ...
  [Language.BS]: {
    ...
    firefighterStations: 'Vatrogasne Stanice',
    firefighterDensity: 'Vatrogasci / Stanovništvo',
    ...
    firefighterStation: {
      municipality: 'Opcina',
      address: 'Adresa',
      memberCount: 'Broj ljudi',
      vehicleCount: 'Broj vozila',
      supervisor: 'Nadredjeni',
      phone: 'Telefon',
      phoneAlt: 'Telefon (dodatni)',
      mobile: 'Mobilni',
      email: 'E-mail',
      postalCode: 'Postanski broj',
      stationType: 'Tip jedinice',
      coordinates: 'Koordinate',
      locationPrecision: 'Preciznost lokacije',
      capacitySource: 'Izvor podataka',
      viewDetails: 'Klikni marker za sve podatke',
      unionContact: 'Savez vatrogasnih organizacija RS',
      types: {
      ...
      locationPrecisions: {
        ...
        'village-center': 'Centar naselja',
        'facility-center': 'Centar objekta',
        'municipality-seat': 'Sjedište opštine',
      },
    },
    riskLevels: {
      low: 'NIZAK',
  ...
  [Language.JA]: {
    ...
    activeLandfills: '埋立地',
    protectedAreas: '保護地域',
    firefighterStations: '消防署',
    firefighterDensity: '消防士 / 人口',
    fireThreats: '火災の脅威',
    hydrological: '水文学',
    classLegend: '分類凡例',
    regionTypes: {
    ...
    firefighterStation: {
      ...
      locationPrecisions: {
        exact: '正確な座標',
        'village-center': '村の中心',
        'facility-center': '施設中心',
        'municipality-seat': '自治体所在地',
      },
    },
    riskLevels: {
      low: '低',
